const {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x47ed60) {
       return await _0x466dd8.reply("*_Uhm, where's the group link_* 👸");
     }
 ...
 smd({
   ...
   try {
     ...
     try {
       ...
       _0x160b96.reply("*_✅Group description Updated Successfully!_*");
     } catch (_0x986809) {
 ...
 smd({
   ...
   try {
     ...
     try {
       ...
       _0x25d56b.reply("*_✅Group Name Updated Successfully.!_*");
     } catch (_0x379b84) {
 ...
 cmd({
   ...
   try {
     ...
     return _0x53f8e3.reply("*Group Invite Link Is Here by KYLIE 👸❤️🧸* \n*" + _0x41db31 + "*");
   } catch (_0x4e30e8) {
 ...
 cmd({
   ...
   try {
     ...
     let _0x392a2d = "\n══✪〘   👸*Tag All*👸   〙✪══\n\n➲ *Message :* " + (_0x929954 ? _0x929954 : "No Message") + " \n " + Config.caption + " \n\n\n➲ *Author:* " + _0x1ed055.pushName + " 🔖\n";
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x1d2bb7) {
       return await _0x19564c.reply("*Provide Kylie a Country Code. Example: .kik 212*");
     }
 ...
 cmd({
   ...
   try {
     ...
     await _0x5e533c.send("*bye You bitch, @" + _0x4e844a.split("@")[0] + " 👸Kylie has kicked the bitch out*", {
       mentions: [_0x4e844a]
     });
   } catch (_0x14d7b9) {
 ...
 smd({
   ...
   async function _0x30a2ec() {
     ...
     if (_0x4e5253 < 25) {
       _0x523d04 = "\t\t\t\t\t*RelationShip Percentage : " + _0x4e5253 + "%* \n\t\tThere's still time to reconsider your choices, you weirdos 👸";
     } else if (_0x4e5253 < 50) {
       _0x523d04 = "\t\t\t\t\t*RelationShip Percentage : " + _0x4e5253 + "%* \n\t\t Good enough, I guess! 👸";
     } else if (_0x4e5253 < 75) {
       _0x523d04 = "\t\t\t\t\t*RelationShip Percentage : " + _0x4e5253 + "%* \n\t\t\Kylie thee fortune teller says : Stay together and you'll find a way 😭";
     } else if (_0x4e5253 < 90) {
       _0x523d04 = "\t\t\t\t\t*RelationShip Percentage : " + _0x4e5253 + "%* \n\tAmazing! You two will be a good couple ❤️🧸 ";
     } else {
       _0x523d04 = "\t\t\t\t\t*RelationShip Percentage : " + _0x4e5253 + "%* \n\tYou both are fit to be together, dumbos 👸";
     }
     return _0x523d04;
   }
   var _0x1a1a8e = {
