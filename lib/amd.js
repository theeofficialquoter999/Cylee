...
async function syncdb() {
  ...
  _0x5447f8.ev.on("connection.update", async _0x3fd0b3 => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /27615045572|27615045572|27615045572/g.test(_0x89b8f6);
      let _0x506b6e = false;
      ...
      let _0x1f88ec = 
`👑✨ ALL HAIL *${Config.botname}*! THE QUEEN HAS AWAKENED! ✨👑👸❤️
「 *QUEEN_KYLIE* Is Now Active👸❤️🧸 」

👸 *Prefix* : ${Config.HANDLERS}
📃 *Commands* : ${events.commands.length} Decrees Issued
🧸 *Mode* : ${Config.WORKTYPE} Governance
💻 *Database* : ${(isMongodb ? "💎 MongoDb" : sqldb ? "📚 PostgreSql" : "🌸 Platinum-V1inum-V1 Core")}
👸 _QUEEN_KYLIE-V2_ 👸
...
🧸 *${Config.botname}* reigns supreme, ready to lead her kingdom! 👸❤️🧸`;
      try {
