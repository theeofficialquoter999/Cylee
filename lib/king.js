...
async function syncdb() {
  ...
  client.ev.on("connection.update", async connectionUpdate => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x1f88ec = 
`ALL_HAIL 👑✨ *${Config.botname}*! THE QUEEN HAS AWAKENED! ✨👑
「 *QUEEN_KYLIE-V2 👸❤️🧸* Now Active 」

👸 *Prefix* : ${Config.HANDLERS}
📃 *Royal Commands* : ${events.commands.length} Decrees Issued
🧸 *Mode* : ${Config.WORKTYPE} Governance
💻 *Database* : ${(isMongodb ? "💎 MongoDb" : sqldb ? "📚 PostgreSql" : "🌸 Platinum Core")}
❤️ _cylee's princess_ ❤️
...
<div class="bounce-text">Platinum-V1</div>
